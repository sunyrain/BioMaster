...
def main():
    ...
    protocol=dict(status='FROZEN_BEFORE_SUPERVISED_TRAINING',created_utc=now(),
        ...
        fit=dict(problem_type='binary',eval_metric='roc_auc',hyperparameters_file='AUTOGLUON_HYPERPARAMETERS.json',
            ...
            learner_random_state='seed',random_initialization='Native internal split RNG varies; library-specific model seeds retained (FastAI hardcodes 0); no old supervised weights',
