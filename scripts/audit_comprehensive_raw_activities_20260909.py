"""Recheck all 574 pairs against unfiltered ChEMBL activity endpoints, read only."""
import sqlite3,json,hashlib
from pathlib import Path
import pandas as pd
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'outputs/joint384_comprehensive_20260909';DB=ROOT/'downloads/chembl_37/chembl_37/chembl_37_sqlite/chembl_37.db';SOURCE=ROOT/'outputs/joint384_design_20260909/ALL_574_AGENT_REVIEW.csv'
def main():
 ...
 rows.to_csv(OUT/'ALL574_RAW_CHEMBL_ACTIVITY_RECORDS.csv.gz',index=False)
