...
> 当前综合推荐：已生成新的384候选（229药、112靶点，对照另计112）。整合原始全端点、24项深核和266药原用途后替换83对；旧384保持不变。请使用[综合推荐版](BIOMASTER_RECOMMENDED384_COMPREHENSIVE_20260909_ZH.md)；下面保留旧版审查与统计历史。
