...
2026-09-21阶段更新：当前先做**双向排序一致性与推荐分歧**；Davis不纳入，实测正确性和泛化优劣判断后置到第二阶段。本页涉及AP、误报率、实测收益和训练暴露审计的内容为后续评价规则，不是第一阶段的启动条件。见[当前范围与矩阵](BIOMASTER_DTI_RANKING_SCOPE_20260921_ZH.md)及[官方权重下载状态](BIOMASTER_DTI_OFFICIAL_WEIGHTS_DOWNLOAD_20260921_ZH.md)。
