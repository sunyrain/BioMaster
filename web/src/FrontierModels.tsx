...
export default function FrontierModels({ kind, identifier, compact = false, initialView = "table" }: {kind?: string; identifier?: string; compact?: boolean; initialView?: "table" | "plot"}) {
